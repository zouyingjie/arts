...
一篇关乎 Django 性能优化的文章：http://bookofstranger.com/optimizing-django-orm-queries-for-best-performance/
...
kubeadm init 时拉取镜像的技巧吧，因为网络原因导致其所需的镜像没法正常下载下来，为了解决这个问题，常用的方式有几种：
